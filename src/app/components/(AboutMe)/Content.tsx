...
export default function Content() {
  return (
    <p className={nanum.className}>
      ...
      하여&nbsp;
      <span className='text-white bg-gray-600 rounded-md'>
        &nbsp;LightHouse 퍼포먼스 약 30% 향상 및 SEO 최적화&nbsp;
      </span>
      를 이끈 경험이 있습니다.
      ...
      의 GitHub Contributions을 기록하고 버전관리, Code Review, Pull & Request를
      통해 코드의 버전을 관리하고 협업하는 것을 즐겨합니다. 좋은 서비스가
      만들어지는 것에는 개인적 역량보단 팀과 함께 만드는 시너지가 중요하다고
      생각하여{' '}
      <span className='text-white bg-gray-600 rounded-md'>
        &nbsp;팀과 팀원의 동반성장&nbsp;
      </span>
      을 추구하여 <strong>철저한 Code Review</strong>를 통해 동료가 작성한
      코드에 대해 충분히 이해를 수반한 협업을 이루어내는 것을 지향합니다.
      <br /> <br />
      ...
      있습니다.
      <br /> <br />
      또한 다양한 직군과 함께 서비스를 만드는 것을 중요히 생각하여{' '}
