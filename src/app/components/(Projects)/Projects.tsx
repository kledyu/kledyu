...
export default function Projects() {
  const PROJECTS = {
    ...
    officener: {
      ...
      details: [
        '실 상용 서비스 ‘오피스너’의 유저 가입자수와 WAU 증진을 위한 개선 웹앱 제작',
